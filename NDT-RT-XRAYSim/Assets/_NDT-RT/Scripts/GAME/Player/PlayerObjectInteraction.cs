...
public class PlayerObjectInteraction : MonoBehaviour
{
    ...
    private ItemObject currentInteractable; // To store the interactable object
    private ItemObject lastInteractable; // To store the last interactable object the player looked at
    ...
    void Update()
    {
        ...
        if (Physics.Raycast(ray, out hit, interactionRange, ignoreLayerMask))
        {
            ...
            ItemObject interactable = hit.transform.GetComponent<ItemObject>();
            ...
            if (interactable != null)
            {
                ...
                if (Input.GetMouseButtonDown(0))
                {
                    ...
                    if(currentInteractable.gameObject.GetComponent<Connector>())
                        if(currentInteractable.gameObject.GetComponent<Connector>().IsConnected)
                            currentInteractable.gameObject.GetComponent<Connector>().Disconnect();
                }
            }
            else
            {
